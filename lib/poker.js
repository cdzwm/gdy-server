...
var thecards = {
	...
	2 : {name : "黑桃2", type : "spades", point : 15, prev : 1},
	...
	15 : {name : "红桃2", type : "hearts", point : 15, prev : 14},
	...
	28 : {name : "梅花2", type : "diamonds", point : 15, prev : 27},
	...
	41 : {name : "方块2", type : "clubs", point : 15, prev : 40},
	...
	53 : {name : "小王", type : "joker", point : 16, next : 54},
	54 : {name : "大王", type : "joker", point : 17, prev : 53}
};
...
module.exports.getSuits = function(cards){
	...
	var suit = { card_type : card_type.none, cards : [] };
	...
	switch(cards.length){
		...
		case 3:
			...
			switch( getKingCount(cards) ){
				case 0 :
					if( !hasTwo( cards ) && cards[0].point + 1 == cards[1].point
				...
				case 1 :
					suit.card_type = card_type.straight;
					if( cards[0].point + 1 == cards[1].point ){
						if( cards[0].point == 3 ){
							// 王只能放在后边，组成一种顺子
							suit.card_type = card_type.straight;
					...
					else if( cards[0].point + 2 == cards[1].point ){
							suit.card_type = card_type.straight;
				...
				case 2 :
					...
					else if( cards[0].point == 4 ){
						suit = { card_type : card_type.none, cards : [] };
						suit.card_type = card_type.straight;
						suit.cards.push(thecards[cards[0].prev], cards[0], thecards[cards[0].next]);
					}
					else if( cards[0].point == 13 ){
						suit = { card_type : card_type.none, cards : [] };
						suit.card_type = card_type.straight;
						suit.cards.push(thecards[cards[0].prev], cards[0], thecards[cards[0].next]);
					}
					else if( cards[0].point == 14 ){
						suit = { card_type : card_type.none, cards : [] };
						suit.card_type = card_type.straight;
...
//	{name : "黑桃5", type : "spades", point : 5, next : 6, prev : 4},
//];

//var cc = [
//	{name : "黑桃3", type : "spades", point : 3, next : 4},
//	{name : "黑桃4", type : "spades", point : 4, next : 5, prev : 3},
//	{name : "黑桃6", type : "spades", point : 6, next : 7, prev : 5}
//];

var cc = [
	{name : "黑桃2", type : "spades", point : 15, prev : 1},
	{name : "红桃2", type : "hearts", point : 15, prev : 14},
	{name : "小王", type : "joker", point : 16, next : 54}
];

var suits = module.exports.getSuits(cc);
