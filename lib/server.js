...
module.exports.clearMessageQueue = function(sessionid){
	var thissession = getSession(sessionid);
	thissession.mq = [];
}

module.exports.clearDataBuffer = function(sessionid){
	var thissession = getSession(sessionid);
	thissession.data = "";
}
module.exports.clearHandlers = function(sessionid){
	var thissession = getSession(sessionid);
	thissession.handlers=[];
}

module.exports.removeSession = function(sessionid){
	var thissession = getSession(sessionid);
...
module.exports.getPlayerCount = function(){
	return _server.playerCount;
}

module.exports.increasePlayerCount = function(){
	_server.playerCount ++;
}
