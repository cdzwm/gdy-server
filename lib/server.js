...
function onData(data){
	...
	if( !helloHash[this.playerKey].hellook 
		&& protocol.hasHelloMessage(helloHash[this.playerKey].data) ){
		helloHash[this.playerKey].hellook = true;
		helloHash[this.playerKey].data = "";
		me.on('hellook', onHelloOk);
		me.emit("hellook");
	}
}
